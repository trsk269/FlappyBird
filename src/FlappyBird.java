...
public class FlappyBird extends JPanel implements ActionListener, KeyListener {
    ...
    // inorder to make the image to the background of the screen we are creating a
    // function
    ...
    public void draw(Graphics g) {
        // background
        g.drawImage(backgroundImg, 0, 0, borderwidth, borderheight, null);// here we are placing the image at top left
